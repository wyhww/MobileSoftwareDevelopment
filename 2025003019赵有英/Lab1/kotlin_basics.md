...
```kotlin
fun main() {
    println("My name is zhaoyouying")
    println("My student ID is 2025003019")
...
```kotlin
fun main(){
    println("Student 2025003019 says hello")
}
```
...
```kotlin
fun main(){
    println("Hello,my name is zhaoyouying")
}
```
...
```kotlin
fun main(){
    println("ID:2025003019")
    println("Nmae:zhaoyouying")
...
```kotlin
fun main(){
    val zhaoyouyingDelivery=2025003019
    println("Package for zhaoyouying will arrive, tracking ID: "+zhaoyouyingDelivery+".")  
}
```
...
```kotlin
fun main(){
    val studentName="zhaoyouying"
    val score =19
    val bonus =9
    val total  = score + bonus
    println("Nmae:$studentName")
...
```kotlin
fun main() {
    println(zhaoyouyingGreeting(age = 9)) 
    println(zhaoyouyingGreeting("zhaoyouying", age = 1)) 
}

fun zhaoyouyingGreeting(name: String = "2025003019", age: Int): String {
...
```kotlin
fun main() {
    printZhaoyouyingWeather("Ankara", 27, 31, "82%")
    printZhaoyouyingWeather("Tokyo", 32, 36, "10%")
    printZhaoyouyingWeather("Cape Town", 59, 64, "2%")
    printZhaoyouyingWeather("Guatemala City", 50, 55, "7%")
}

fun printZhaoyouyingWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: String) {
    println("City:$city")
