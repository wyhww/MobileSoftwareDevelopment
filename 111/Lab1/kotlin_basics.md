...
```kotlin
fun main() {
	println("My name is xubinhao")
    println("My student ID is 2025003003")
...
```kotlin
fun main() {
    println("Student 2025003003 says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is xubinhao")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003003") 
    println("Name: xubinhao") 
...
```kotlin
fun main() {
	val operandOne: Int = 00
    val operandTwo: Int = 3
...
```kotlin
fun main() {
    printInfo(xubinhao(age = 3))       
    printInfo(xubinhao("xubinhao", 0))   
}

fun xubinhao(name: String = "2025003003", age: Int): String {
...
```kotlin
fun main() {
    printXubinhaoWeather("Ankara", 27, 31, 82)
    printXubinhaoWeather("Tokyo", 32, 36, 10)
    printXubinhaoWeather("Cape Town", 59, 64, 2)
    printXubinhaoWeather("Guatemala City", 50, 55, 7)
}

fun printXubinhaoWeather(cityName: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
