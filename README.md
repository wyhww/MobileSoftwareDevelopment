...
```bash
git remote add upstream https://github.com/LiuXiYing/MobileSoftwareDevelopment.git
```
...
upstream  https://github.com/LiuXiYing/MobileSoftwareDevelopment.git (fetch)
upstream  https://github.com/LiuXiYing/MobileSoftwareDevelopment.git (push)
```
...
### 2. 每次作业在自己的文件夹下新建作业目录和作业文件，并完成作业（以Lab1为例）
