...
// 请将修正后的完整代码粘贴至此
fun main() {
    println("Student 2025003005 says hello")
}
```
...
// 请将完整代码粘贴至此
fun main() {
    val numberOfMessages = "05"
    println("My ID is $numberOfMessages")
}
```
...
// 请将完整代码粘贴至此
fun main() {
    val litaiguoDelivery = "2025003005"
    println("Package for litaiguo will arrive, tracking ID: $litaiguoDelivery.")
}
```
...
// 请将完整代码粘贴至此
fun main() {
    println(litaiguoGreeting(age = 5))
    println(litaiguoGreeting("litaiguo", 0))
}

fun litaiguoGreeting(name: String = "2025003005", age: Int): String {
...
// 请将完整代码粘贴至此
fun main() {
    printLitaiguoWeather("Ankara", 27, 31, "82%")
    printLitaiguoWeather("Tokyo", 32, 36, "10%")
    printLitaiguoWeather("Cape Town", 59, 64, "2%")
    printLitaiguoWeather("Guatemala City", 50, 55, "7%")
}

fun printLitaiguoWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: String) {
    println("City: $city")
