...
```kotlin
fun main() {
    println("My name is oumei")
    println("My student ID is 2025003024")
...
```kotlin
fun main() {
    println("Student [2025003024] says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is [oumei]")
}
```
...
```kotlin
fun main() {
    val name: String = "oumei"
    val studentID: String = "2025003024"
...
fun main() {
    ...
    val totalCount: Int = unreadCount + readCount
    println("你总共收到了${unreadCount + readCount }条消息。其中 $unreadCount 条未读，$readCount 条已读。")
	println("你总共收到了 $totalCount 条消息。")
}
```
...
```kotlin
fun main() {
    println(oumeiGreeting(age = 4))       
    println(oumeiGreeting("oumei", 2))  
}

fun oumeiGreeting(name: String = "2025003024", age: Int):String {
...
```kotlin
fun printOumeiWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: String) {
    println("City:$city")
...
fun main() {
    printOumeiWeather("Ankara", 27, 31, "82%")
    printOumeiWeather("Tokyo", 32, 36, "10%")
    printOumeiWeather("Cape Town", 59, 64, "2%")
    printOumeiWeather("Guatemala City", 50, 55, "7%")
}
```
