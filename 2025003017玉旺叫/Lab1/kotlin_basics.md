...
```kotlin
fun main() {
    println("My name is yuwangjiao")
    println("My student ID is 2025003017")
...
```kotlin
fun main() {
    val yuwanggjiaoDelivery = "2025003017"
    val name = "yuwangjiao"
    println("Package for " + name + " will arrive, tracking ID: " + yuwangjiaoDelivery + ".")
}
```
...
```kotlin
fun main() {
    println(yuwangjiaoGreeting(age = 7))
    println(yuwangjiaoGreeting("yuwangjiao", 1))
}
fun yuwangjiaoGreeting(name: String = "2025003017", age: Int): String {
...
```kotlin
fun main() {
    printYuwangjiaoWeather("Ankara", 27, 31, 82)
    printYuwangjiaoWeather("Tokyo", 32, 36, 10)
    printYuwangjiaoWeather("Cape Town", 59, 64, 2)
    printYuwangjiaoWeather("Guatemala City", 50, 55, 7)
}
fun printYuwangjiaoWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
