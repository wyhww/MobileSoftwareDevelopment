...
```kotlin
fun main() {
	println("My name is yangshuhao")
    println("My student ID is 2025003035")
...
```kotlin
fun main() {
    println("Student 2025003035 says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is yangshuhao")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003035") 
    println("Name: yangshuhao") 
...
预输出（姓名 `zhangwei`，学号 `20231042` 时的示例）：
...
```kotlin
fun main() {
    val yangshuhao = "2025003035"
    println("Package for yangshuhao will arrive, tracking ID:" + yangshuhao)
}
```
...
```kotlin
fun main() {
	val operandOne: Int = 3
    val operandTwo: Int = 5
...
```kotlin
fun main() {
    printInfo(yangshuhao(age = 5))       
    printInfo(yangshuhao("yangshuhao", 3))   
}

fun yangshuhao(name: String = "2025003035", age: Int): String {
...
```kotlin
fun main() {
    printYangshuhaoWeather("Ankara", 27, 31, 82)
    printYangshuhaoWeather("Tokyo", 32, 36, 10)
    printYangshuhaoWeather("Cape Town", 59, 64, 2)
    printYangshuhaoWeather("Guatemala City", 50, 55, 7)
}

fun printYangshuhaoWeather(cityName: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
